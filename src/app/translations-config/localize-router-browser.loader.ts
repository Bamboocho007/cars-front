...
export class LocalizeRouterBrowserLoader extends LocalizeParser {
...
export function localizeRouterBrowserLoaderFactory(
  ...
  if (data) {
    return new LocalizeRouterBrowserLoader(translate, location, settings, data);
  } else {
